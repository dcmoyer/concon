...
#ifndef C3_EFFECTIVE_CONNECTIVITY_HPP
#define C3_EFFECTIVE_CONNECTIVITY_HPP
...
class Effective_Connectivity : public c3::Subject {
public:
  Effective_Connectivity();
  ~Effective_Connectivity();
...
protected:
  int N_output;
  double ** output_numerator;
  double ** output_denominator;
  double epsilon;
  double final_thold;

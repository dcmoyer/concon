...
//v->out halfedge
    ...
    {
    public:
        VertexOutHalfedgeIterator( const Solid::tSolid solid,
          const Solid::tVertex  & v )
        { m_solid = solid; m_vertex = v; m_halfedge = solid->vertexMostClwOutHalfEdge(v);};

        ~VertexOutHalfedgeIterator(){};
        void operator++()
        {
            if ( m_halfedge == NULL ) throw TopologyException((char*)"iterators");
...
//v->in halfedge
    ...
    {
    public:
        VertexInHalfedgeIterator( const Solid::tSolid solid,
          const Solid::tVertex & v )
...
//v -> v
    ...
    public:
        ...
        VertexVertexIterator( const Solid::tVertex  v )
        { 
            m_vertex = v; 
...
//v -> edge
    ...
    public:
        ...
        VertexEdgeIterator( const Solid::tVertex  v )
        { 
            m_vertex = v; 
            m_halfedge = m_vertex->most_clw_out_halfedge();
        };
...
// v->face
    ...
    {
    public:
        VertexFaceIterator( const Solid::tVertex & v )
        { 
            m_vertex = v; 
            m_halfedge = m_vertex->most_clw_out_halfedge(); 
        };
...
// f -> halfedge
    ...
    public:
        ...
        FaceHalfedgeIterator( const Solid::tFace & f )
        { 
            m_face = f; 
...
// f -> edge
    ...
    public:
        ...
        FaceEdgeIterator( const Solid::tFace & f )
        { 
            m_face = f; 
            m_halfedge = f->halfedge(); 
        };
...
// f -> vertex
    ...
    public:
        ...
        FaceVertexIterator( const Solid::tFace & f )
        { 
            m_face = f; 
            m_halfedge = f->halfedge(); 
        };
		...
		void reset(){m_halfedge = m_face->halfedge();}
        bool end(){ return m_halfedge == NULL;};
...
// solid vertices
    ...
    {
    public:
        SolidVertexIterator( const Solid::tSolid solid ) :
          m_solid(solid), m_iter( solid->m_verts )
        {
        }
...
// solid faces
    ...
    {
    public:
        SolidFaceIterator( const Solid::tSolid solid ) :
          m_solid(solid), m_iter( solid->m_faces )
        {
        }
...
// solid edges
    ...
    {
    public:
        SolidEdgeIterator( const Solid::tSolid solid ) :
          m_solid(solid), m_iter( solid->m_edges )
        {
        }
...
// solid halfedges
    ...
    {
    public:
        SolidHalfEdgeIterator( const Solid::tSolid solid ) :
          m_solid(solid), m_iter( solid->m_edges ), m_id(0)
        {
        }
